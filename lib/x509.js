...
define(['require', './rsa_api', './asn1hex', './base64'], function(require) {
    var my = {};
// 
...
function _x509_pemToHex(sCertPEM) {
  ...
  var hCert = base64.b64tohex(b64Cert);
  return hCert;
}
...
function _x509_readCertPEM(sCertPEM) {
  ...
  key.setPublic(a[0], a[1]);
  this.subjectPublicKeyRSA = key;
